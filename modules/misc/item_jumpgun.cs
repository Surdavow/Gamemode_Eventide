...
datablock ItemData(jumpgunItem)
{
	...
	shapeFile = "Add-Ons/Gamemode_Eventide/modules/misc/models/Dark.dts";
	rotate = false;
	mass = 0.2;
	density = 0.1;
	elasticity = 0.8;
	...
	uiName = "Shadowport";
	iconName = "Add-Ons/Gamemode_Eventide/modules/misc/icons/Icon_Darkness";
	doColorShift = false;
